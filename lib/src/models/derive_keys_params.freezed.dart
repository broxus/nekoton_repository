...
extension DeriveKeysParamsPatterns on DeriveKeysParams {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(DeriveKeysParamsDerived value)? derived,
    TResult Function(DeriveKeysParamsLedger value)? ledger,
    ...
    switch (_that) {
      ...
      case DeriveKeysParamsLedger() when ledger != null:
        return ledger(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(DeriveKeysParamsDerived value) derived,
    required TResult Function(DeriveKeysParamsLedger value) ledger,
  }) {
    final _that = this;
    switch (_that) {
      case DeriveKeysParamsDerived():
        return derived(_that);
      case DeriveKeysParamsLedger():
        return ledger(_that);
    }
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(int accountId, PublicKey masterKey, String password)?
        derived,
    TResult Function(int accountId)? ledger,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case DeriveKeysParamsDerived() when derived != null:
        return derived(_that.accountId, _that.masterKey, _that.password);
      case DeriveKeysParamsLedger() when ledger != null:
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(
        ...
        derived,
    required TResult Function(int accountId) ledger,
  }) {
    final _that = this;
    switch (_that) {
      case DeriveKeysParamsDerived():
