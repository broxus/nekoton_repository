...
extension ContractFoundTransactionEventPatterns
    on ContractFoundTransactionEvent {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ContractFoundTransactionEvent value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Address address, List<Transaction> transactions,
            TransactionsBatchInfo info)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ContractFoundTransactionEvent() when $default != null:
        return $default(_that.address, _that.transactions, _that.info);
      case _:
        return orElse();
    }
  }
