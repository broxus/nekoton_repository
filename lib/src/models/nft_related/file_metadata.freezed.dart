...
mixin _$FileMetadata {
 ...
 String? get source;@JsonKey(readValue: _readValue) String? get mimetype;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FileMetadata&&(identical(other.source, source) || other.source == source)&&(identical(other.mimetype, mimetype) || other.mimetype == mimetype));
}
...
@useResult
$Res call({
 String? source,@JsonKey(readValue: _readValue) String? mimetype
});
...
/// Create a copy of FileMetadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? source = freezed,Object? mimetype = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? source, @JsonKey(readValue: _readValue)  String? mimetype)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FileMetadata() when $default != null:
return $default(_that.source,_that.mimetype);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? source, @JsonKey(readValue: _readValue)  String? mimetype)  $default,) {final _that = this;
switch (_that) {
case _FileMetadata():
return $default(_that.source,_that.mimetype);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? source, @JsonKey(readValue: _readValue)  String? mimetype)?  $default,) {final _that = this;
switch (_that) {
case _FileMetadata() when $default != null:
return $default(_that.source,_that.mimetype);case _:
  return null;
...
class _FileMetadata implements FileMetadata {
  const _FileMetadata({this.source, @JsonKey(readValue: _readValue) this.mimetype});
  factory _FileMetadata.fromJson(Map<String, dynamic> json) => _$FileMetadataFromJson(json);

@override final  String? source;
@override@JsonKey(readValue: _readValue) final  String? mimetype;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FileMetadata&&(identical(other.source, source) || other.source == source)&&(identical(other.mimetype, mimetype) || other.mimetype == mimetype));
}
...
/// Create a copy of FileMetadata
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? source = freezed,Object? mimetype = freezed,}) {
