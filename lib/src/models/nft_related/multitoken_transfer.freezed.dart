...
extension MultitokenTransferPatterns on MultitokenTransfer {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MultitokenTransfer value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String tokenId, Address collection, Address sender,
            @amountJsonConverter BigInt count)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _MultitokenTransfer() when $default != null:
        return $default(
            _that.tokenId, _that.collection, _that.sender, _that.count);
      case _:
        return orElse();
    }
  }
