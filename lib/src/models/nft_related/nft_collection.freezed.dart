...
extension NftCollectionPatterns on NftCollection {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NftCollection value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Address address, NftJsonData json,
            List<ContractInterface> interfaces)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NftCollection() when $default != null:
        return $default(_that.address, _that.json, _that.interfaces);
      case _:
        return orElse();
    }
  }
