...
mixin _$NftInfo {
 ...
 String get id; Address get owner; Address get manager; Address get collection;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NftInfo&&(identical(other.id, id) || other.id == id)&&(identical(other.owner, owner) || other.owner == owner)&&(identical(other.manager, manager) || other.manager == manager)&&(identical(other.collection, collection) || other.collection == collection));
}
...
$AddressCopyWith<$Res> get owner;$AddressCopyWith<$Res> get manager;$AddressCopyWith<$Res> get collection;
...
/// Create a copy of NftInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? owner = null,Object? manager = null,Object? collection = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,owner: null == owner ? _self.owner : owner // ignore: cast_nullable_to_non_nullable
as Address,manager: null == manager ? _self.manager : manager // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  Address owner,  Address manager,  Address collection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NftInfo() when $default != null:
return $default(_that.id,_that.owner,_that.manager,_that.collection);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  Address owner,  Address manager,  Address collection)  $default,) {final _that = this;
switch (_that) {
case _NftInfo():
return $default(_that.id,_that.owner,_that.manager,_that.collection);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  Address owner,  Address manager,  Address collection)?  $default,) {final _that = this;
switch (_that) {
case _NftInfo() when $default != null:
return $default(_that.id,_that.owner,_that.manager,_that.collection);case _:
  return null;
...
class _NftInfo implements NftInfo {
  const _NftInfo({required this.id, required this.owner, required this.manager, required this.collection});
  factory _NftInfo.fromJson(Map<String, dynamic> json) => _$NftInfoFromJson(json);

@override final  String id;
@override final  Address owner;
@override final  Address manager;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NftInfo&&(identical(other.id, id) || other.id == id)&&(identical(other.owner, owner) || other.owner == owner)&&(identical(other.manager, manager) || other.manager == manager)&&(identical(other.collection, collection) || other.collection == collection));
}
...
@override $AddressCopyWith<$Res> get owner;@override $AddressCopyWith<$Res> get manager;@override $AddressCopyWith<$Res> get collection;
...
/// Create a copy of NftInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? owner = null,Object? manager = null,Object? collection = null,}) {
