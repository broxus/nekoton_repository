...
mixin _$NftTransferEvent {
 ...
 TransferDirection get direction; String get id; Address get collection; Address get sender; Address get recipient;
/// Create a copy of NftTransferEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NftTransferEventCopyWith<NftTransferEvent> get copyWith => _$NftTransferEventCopyWithImpl<NftTransferEvent>(this as NftTransferEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NftTransferEvent&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.id, id) || other.id == id)&&(identical(other.collection, collection) || other.collection == collection)&&(identical(other.sender, sender) || other.sender == sender)&&(identical(other.recipient, recipient) || other.recipient == recipient));
}


@override
int get hashCode => Object.hash(runtimeType,direction,id,collection,sender,recipient);
...
abstract mixin class $NftTransferEventCopyWith<$Res>  {
  factory $NftTransferEventCopyWith(NftTransferEvent value, $Res Function(NftTransferEvent) _then) = _$NftTransferEventCopyWithImpl;
@useResult
$Res call({
 TransferDirection direction, String id, Address collection, Address sender, Address recipient
});


$AddressCopyWith<$Res> get collection;$AddressCopyWith<$Res> get sender;$AddressCopyWith<$Res> get recipient;
...
/// Create a copy of NftTransferEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? direction = null,Object? id = null,Object? collection = null,Object? sender = null,Object? recipient = null,}) {
  return _then(_self.copyWith(
direction: null == direction ? _self.direction : direction // ignore: cast_nullable_to_non_nullable
as TransferDirection,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NftOwnershipTransferEvent value)?  ownership,TResult Function( NftTokenTransferEvent value)?  token,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NftOwnershipTransferEvent() when ownership != null:
return ownership(_that);case NftTokenTransferEvent() when token != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NftOwnershipTransferEvent value)  ownership,required TResult Function( NftTokenTransferEvent value)  token,}){
final _that = this;
switch (_that) {
case NftOwnershipTransferEvent():
return ownership(_that);case NftTokenTransferEvent():
return token(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NftOwnershipTransferEvent value)?  ownership,TResult? Function( NftTokenTransferEvent value)?  token,}){
final _that = this;
switch (_that) {
case NftOwnershipTransferEvent() when ownership != null:
return ownership(_that);case NftTokenTransferEvent() when token != null:
...
return token(_that.direction,_that.id,_that.collection,_that.sender,_that.recipient,_that.count);case _:
  return orElse();
...
return token(_that.direction,_that.id,_that.collection,_that.sender,_that.recipient,_that.count);}
}
...
class NftOwnershipTransferEvent implements NftTransferEvent {
  const NftOwnershipTransferEvent({required this.direction, required this.id, required this.collection, required this.sender, required this.recipient});
...
@pragma('vm:prefer-inline')
$NftOwnershipTransferEventCopyWith<NftOwnershipTransferEvent> get copyWith => _$NftOwnershipTransferEventCopyWithImpl<NftOwnershipTransferEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NftOwnershipTransferEvent&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.id, id) || other.id == id)&&(identical(other.collection, collection) || other.collection == collection)&&(identical(other.sender, sender) || other.sender == sender)&&(identical(other.recipient, recipient) || other.recipient == recipient));
}
...
/// @nodoc
abstract mixin class $NftOwnershipTransferEventCopyWith<$Res> implements $NftTransferEventCopyWith<$Res> {
  factory $NftOwnershipTransferEventCopyWith(NftOwnershipTransferEvent value, $Res Function(NftOwnershipTransferEvent) _then) = _$NftOwnershipTransferEventCopyWithImpl;
@override @useResult
$Res call({
 TransferDirection direction, String id, Address collection, Address sender, Address recipient
});
...
@override $AddressCopyWith<$Res> get collection;@override $AddressCopyWith<$Res> get sender;@override $AddressCopyWith<$Res> get recipient;
...
/// Create a copy of NftTransferEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? direction = null,Object? id = null,Object? collection = null,Object? sender = null,Object? recipient = null,}) {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NftTokenTransferEventCopyWith<NftTokenTransferEvent> get copyWith => _$NftTokenTransferEventCopyWithImpl<NftTokenTransferEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NftTokenTransferEvent&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.id, id) || other.id == id)&&(identical(other.collection, collection) || other.collection == collection)&&(identical(other.sender, sender) || other.sender == sender)&&(identical(other.recipient, recipient) || other.recipient == recipient)&&(identical(other.count, count) || other.count == count));
}


@override
int get hashCode => Object.hash(runtimeType,direction,id,collection,sender,recipient,count);
...
/// @nodoc
abstract mixin class $NftTokenTransferEventCopyWith<$Res> implements $NftTransferEventCopyWith<$Res> {
...
/// Create a copy of NftTransferEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? direction = null,Object? id = null,Object? collection = null,Object? sender = null,Object? recipient = null,Object? count = null,}) {
