...
NftTransferInput _$NftTransferInputFromJson(Map<String, dynamic> json) {
  return _NftTransferInput.fromJson(json);
}
...
mixin _$NftTransferInput {
  ...
  Address get sendGasTo =>
      throw _privateConstructorUsedError; // json_serializable wont work with Address keys
  Map<String, NftCallbackPayload> get callbacks =>
      throw _privateConstructorUsedError;

  /// Serializes this NftTransferInput to a JSON map.
...
abstract class $NftTransferInputCopyWith<$Res> {
  ...
  $Res call(
      {Address to,
      Address sendGasTo,
      Map<String, NftCallbackPayload> callbacks});
    ...
    return _then(_value.copyWith(
      ...
      callbacks: null == callbacks
          ...
          : callbacks // ignore: cast_nullable_to_non_nullable
              as Map<String, NftCallbackPayload>,
    ) as $Val);
  }
...
/// @nodoc
@JsonSerializable()
class _$NftTransferInputImpl implements _NftTransferInput {
  const _$NftTransferInputImpl(
      {required this.to,
      required this.sendGasTo,
      required final Map<String, NftCallbackPayload> callbacks})
      : _callbacks = callbacks;

  factory _$NftTransferInputImpl.fromJson(Map<String, dynamic> json) =>
      _$$NftTransferInputImplFromJson(json);
...
// json_serializable wont work with Address keys
  final Map<String, NftCallbackPayload> _callbacks;
// json_serializable wont work with Address keys
  @override
  Map<String, NftCallbackPayload> get callbacks {
  ...
  Map<String, dynamic> toJson() {
    return _$$NftTransferInputImplToJson(
      this,
    );
  }
}

abstract class _NftTransferInput implements NftTransferInput {
  ...
  factory _NftTransferInput.fromJson(Map<String, dynamic> json) =
      _$NftTransferInputImpl.fromJson;

  @override
  Address get to;
  @override
  Address get sendGasTo; // json_serializable wont work with Address keys
  @override
  Map<String, NftCallbackPayload> get callbacks;
