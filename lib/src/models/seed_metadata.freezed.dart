...
extension SeedMetadataPatterns on SeedMetadata {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SeedMetadata value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? name, int? addedAt, SeedAddType? addType)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SeedMetadata() when $default != null:
        return $default(_that.name, _that.addedAt, _that.addType);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String? name, int? addedAt, SeedAddType? addType) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _SeedMetadata():
