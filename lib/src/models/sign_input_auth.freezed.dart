...
extension SignInputAuthPatterns on SignInputAuth {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(SignInputAuthPassword value)? password,
    TResult Function(SignInputAuthLedger value)? ledger,
    ...
    switch (_that) {
      ...
      case SignInputAuthLedger() when ledger != null:
        return ledger(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(SignInputAuthPassword value) password,
    required TResult Function(SignInputAuthLedger value) ledger,
  }) {
    final _that = this;
    switch (_that) {
      case SignInputAuthPassword():
        return password(_that);
      case SignInputAuthLedger():
        return ledger(_that);
    }
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(WalletType wallet, LedgerSignatureContext? context)?
        ledger,
    required TResult orElse(),
  }) {
    final _that = this;
