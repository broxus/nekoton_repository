...
$TokenWalletOrdinaryTransactionCopyWith<TokenWalletOrdinaryTransaction> get copyWith => _$TokenWalletOrdinaryTransactionCopyWithImpl<TokenWalletOrdinaryTransaction>(this as TokenWalletOrdinaryTransaction, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TokenWalletOrdinaryTransaction&&(identical(other.lt, lt) || other.lt == lt)&&(identical(other.isOutgoing, isOutgoing) || other.isOutgoing == isOutgoing)&&(identical(other.value, value) || other.value == value)&&(identical(other.address, address) || other.address == address)&&(identical(other.date, date) || other.date == date)&&(identical(other.fees, fees) || other.fees == fees)&&(identical(other.hash, hash) || other.hash == hash)&&(identical(other.prevTransactionLt, prevTransactionLt) || other.prevTransactionLt == prevTransactionLt)&&(identical(other.incomingTransfer, incomingTransfer) || other.incomingTransfer == incomingTransfer)&&(identical(other.outgoingTransfer, outgoingTransfer) || other.outgoingTransfer == outgoingTransfer)&&(identical(other.swapBack, swapBack) || other.swapBack == swapBack)&&(identical(other.accept, accept) || other.accept == accept)&&(identical(other.transferBounced, transferBounced) || other.transferBounced == transferBounced)&&(identical(other.swapBackBounced, swapBackBounced) || other.swapBackBounced == swapBackBounced)&&(identical(other.jettonIncomingTransfer, jettonIncomingTransfer) || other.jettonIncomingTransfer == jettonIncomingTransfer)&&(identical(other.jettonOutgoingTransfer, jettonOutgoingTransfer) || other.jettonOutgoingTransfer == jettonOutgoingTransfer));
}


@override
int get hashCode => Object.hash(runtimeType,lt,isOutgoing,value,address,date,fees,hash,prevTransactionLt,incomingTransfer,outgoingTransfer,swapBack,accept,transferBounced,swapBackBounced,jettonIncomingTransfer,jettonOutgoingTransfer);
...
$AddressCopyWith<$Res> get address;$TokenIncomingTransferCopyWith<$Res>? get incomingTransfer;$TokenOutgoingTransferCopyWith<$Res>? get outgoingTransfer;$TokenSwapBackCopyWith<$Res>? get swapBack;$JettonIncomingTransferCopyWith<$Res>? get jettonIncomingTransfer;$JettonOutgoingTransferCopyWith<$Res>? get jettonOutgoingTransfer;
...
/// Create a copy of TokenWalletOrdinaryTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lt = null,Object? isOutgoing = null,Object? value = null,Object? address = null,Object? date = null,Object? fees = null,Object? hash = null,Object? prevTransactionLt = freezed,Object? incomingTransfer = freezed,Object? outgoingTransfer = freezed,Object? swapBack = freezed,Object? accept = freezed,Object? transferBounced = freezed,Object? swapBackBounced = freezed,Object? jettonIncomingTransfer = freezed,Object? jettonOutgoingTransfer = freezed,}) {
...
as String?,incomingTransfer: freezed == incomingTransfer ? _self.incomingTransfer : incomingTransfer // ignore: cast_nullable_to_non_nullable
as TokenIncomingTransfer?,outgoingTransfer: freezed == outgoingTransfer ? _self.outgoingTransfer : outgoingTransfer // ignore: cast_nullable_to_non_nullable
as TokenOutgoingTransfer?,swapBack: freezed == swapBack ? _self.swapBack : swapBack // ignore: cast_nullable_to_non_nullable
as TokenSwapBack?,accept: freezed == accept ? _self.accept : accept // ignore: cast_nullable_to_non_nullable
as BigInt?,transferBounced: freezed == transferBounced ? _self.transferBounced : transferBounced // ignore: cast_nullable_to_non_nullable
as BigInt?,swapBackBounced: freezed == swapBackBounced ? _self.swapBackBounced : swapBackBounced // ignore: cast_nullable_to_non_nullable
as BigInt?,jettonIncomingTransfer: freezed == jettonIncomingTransfer ? _self.jettonIncomingTransfer : jettonIncomingTransfer // ignore: cast_nullable_to_non_nullable
as JettonIncomingTransfer?,jettonOutgoingTransfer: freezed == jettonOutgoingTransfer ? _self.jettonOutgoingTransfer : jettonOutgoingTransfer // ignore: cast_nullable_to_non_nullable
...
$TokenIncomingTransferCopyWith<$Res>? get incomingTransfer {
  ...
  return $TokenIncomingTransferCopyWith<$Res>(_self.incomingTransfer!, (value) {
...
$TokenOutgoingTransferCopyWith<$Res>? get outgoingTransfer {
  ...
  return $TokenOutgoingTransferCopyWith<$Res>(_self.outgoingTransfer!, (value) {
...
$JettonIncomingTransferCopyWith<$Res>? get jettonIncomingTransfer {
  ...
  return $JettonIncomingTransferCopyWith<$Res>(_self.jettonIncomingTransfer!, (value) {
...
$JettonOutgoingTransferCopyWith<$Res>? get jettonOutgoingTransfer {
  ...
  return $JettonOutgoingTransferCopyWith<$Res>(_self.jettonOutgoingTransfer!, (value) {
...
extension TokenWalletOrdinaryTransactionPatterns on TokenWalletOrdinaryTransaction {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TokenWalletOrdinaryTransaction value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TokenWalletOrdinaryTransaction value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TokenWalletOrdinaryTransaction value)?  $default,){
final _that = this;
switch (_that) {
case _TokenWalletOrdinaryTransaction() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$TokenWalletOrdinaryTransactionCopyWith<_TokenWalletOrdinaryTransaction> get copyWith => __$TokenWalletOrdinaryTransactionCopyWithImpl<_TokenWalletOrdinaryTransaction>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TokenWalletOrdinaryTransaction&&(identical(other.lt, lt) || other.lt == lt)&&(identical(other.isOutgoing, isOutgoing) || other.isOutgoing == isOutgoing)&&(identical(other.value, value) || other.value == value)&&(identical(other.address, address) || other.address == address)&&(identical(other.date, date) || other.date == date)&&(identical(other.fees, fees) || other.fees == fees)&&(identical(other.hash, hash) || other.hash == hash)&&(identical(other.prevTransactionLt, prevTransactionLt) || other.prevTransactionLt == prevTransactionLt)&&(identical(other.incomingTransfer, incomingTransfer) || other.incomingTransfer == incomingTransfer)&&(identical(other.outgoingTransfer, outgoingTransfer) || other.outgoingTransfer == outgoingTransfer)&&(identical(other.swapBack, swapBack) || other.swapBack == swapBack)&&(identical(other.accept, accept) || other.accept == accept)&&(identical(other.transferBounced, transferBounced) || other.transferBounced == transferBounced)&&(identical(other.swapBackBounced, swapBackBounced) || other.swapBackBounced == swapBackBounced)&&(identical(other.jettonIncomingTransfer, jettonIncomingTransfer) || other.jettonIncomingTransfer == jettonIncomingTransfer)&&(identical(other.jettonOutgoingTransfer, jettonOutgoingTransfer) || other.jettonOutgoingTransfer == jettonOutgoingTransfer));
}
...
/// @nodoc
abstract mixin class _$TokenWalletOrdinaryTransactionCopyWith<$Res> implements $TokenWalletOrdinaryTransactionCopyWith<$Res> {
...
@override $AddressCopyWith<$Res> get address;@override $TokenIncomingTransferCopyWith<$Res>? get incomingTransfer;@override $TokenOutgoingTransferCopyWith<$Res>? get outgoingTransfer;@override $TokenSwapBackCopyWith<$Res>? get swapBack;@override $JettonIncomingTransferCopyWith<$Res>? get jettonIncomingTransfer;@override $JettonOutgoingTransferCopyWith<$Res>? get jettonOutgoingTransfer;
...
/// Create a copy of TokenWalletOrdinaryTransaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lt = null,Object? isOutgoing = null,Object? value = null,Object? address = null,Object? date = null,Object? fees = null,Object? hash = null,Object? prevTransactionLt = freezed,Object? incomingTransfer = freezed,Object? outgoingTransfer = freezed,Object? swapBack = freezed,Object? accept = freezed,Object? transferBounced = freezed,Object? swapBackBounced = freezed,Object? jettonIncomingTransfer = freezed,Object? jettonOutgoingTransfer = freezed,}) {
