...
extension PendingTransactionWithDataPatterns on PendingTransactionWithData {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(PendingTransaction transaction, Address destination,
            @amountJsonConverter BigInt amount, DateTime createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _PendingTransactionWithAdditionalInfo() when $default != null:
        return $default(_that.transaction, _that.destination, _that.amount,
            _that.createdAt);
      case _:
        return orElse();
    }
